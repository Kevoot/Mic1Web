...
int pc, sp;
	...
	exit(1);
     ...
     FILE *prom_raw_file = fopen("data/prom.dat", "r");
     FILE *program_raw_file = fopen("data/ifib.asm", "r");

     nonblock_stdin_channel_flags = original_stdin_channel_flags | O_NONBLOCK;

     switch(argc){
       case 0:   strcpy(promfile, prom_raw_file);
                 strcpy(programfile, program_raw_file);
                 pc = -1;
                 sp = -1;
       case 1:   promfile[0] = '\0';
                 programfile[0] =  '\0';
                 ...
                 sp = -1;
                 break;
       case 2:   strcpy(promfile, prom_raw_file);
                 programfile[0] =  '\0';
                 pc = -1;
                 sp = -1;
                 break;
       case 3:   strcpy(promfile, prom_raw_file);
                 strcpy(programfile, program_raw_file);
                 pc = -1;
                 sp = -1;
                 break;
       case 4:   strcpy(promfile, prom_raw_file);
                 strcpy(programfile, program_raw_file);
                 pc = atoi(argv[3]);
                 sp = -1;
                 break;
       case 5:   strcpy(promfile, prom_raw_file);
                 strcpy(programfile, program_raw_file);
                 pc = atoi(argv[3]);
                 sp = atoi(argv[4]);
                 break;
